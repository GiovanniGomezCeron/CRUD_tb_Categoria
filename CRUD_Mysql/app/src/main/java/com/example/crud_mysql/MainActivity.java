...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Login.json=new OperacionesJSON();
        Login.context=getApplicationContext();
        Login.producto = new Producto();
        Login.categoria = new Categoria();
      ...
      //  json.RecibirUser();
       ...
       // mAppBarConfiguration = new AppBarConfiguration.Builder(R.id.nav_home, R.id.categoria,R.id.Productos,R.id.AggProducto).setDrawerLayout(drawer).build();
            ...
            mAppBarConfiguration = new AppBarConfiguration.Builder(R.id.nav_home, R.id.categoria).setDrawerLayout(drawer).build();
